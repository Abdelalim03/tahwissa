...
function AddPointForm(props) {
  ...
  return (
    <div className='example py-16  min-h-screen overflow-auto flex flex-col gap-10'>
        <div className=' mt-10 mx-auto flex flex-col gap-2'>
         
          <Title first={'Add New Point'} />
          
        </div>
        <htmlForm onSubmit={handleSubmit} className=' shadow-xl mx-auto py-6  px-7 md:px-14 lg:px-16 flex flex-col gap-5'>
          <div className='w-full flex flex-col gap-1'>
            <p className='text-lg md:text-left text-center mb-2'>Choose the announce themes : </p>
          ...
          <div className='w-full flex flex-col gap-1'>
            <p className='text-lg text-center md:text-left mb-2'>Select the intrest point category :</p>
          ...
          <div className='flex flex-col gap-5 md:flex-row items-center  lg:flex-row md:justify-between '>
            ...
            <div className="App text-sm">
              <div className='flex'>
                  <label className='w-[340px] lg:w-[500px] bg-mainGray cursor-pointer mb-2 text-lg  text-gray-900 text-center  p-2 shadow-sm rounded-sm font-bold' htmlFor="fileUpload">Upload images</label>
                  ...
                  <div className='w-[340px] lg:w-[500px] flex flex-col justify-center items-center gap-2 text-sm'>
                      ...
                      <div 
                      className={`${(uploadedFiles.length === 0) && 'hidden'} rounded-lg cursor-pointer p-2 w-fit flex justify-center items-center  bg-[#EE462F]`}
                      onClick = {() => {
                          setUploadedFiles([])
                          setFileLimit(false)
                      }}
          ...
          <div className='flex flex-row-reverse w-full'>
            ...
            <label htmlFor="submit" className='submit-button rounded-lg p-2 w-fit flex justify-center items-center gap-2 cursor-pointer hover:scale-110 bg-[#EE462F] text-white'>
